    ...
    public partial class @decimal : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestCategoris", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNo = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Restaurants_RestCategoris_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "RestCategoris",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Discounts_Restaurants_ProviderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuCategories_Restaurants_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DesiredTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PayTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PayType = table.Column<int>(type: "int", nullable: true),
                    PayCard = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    PayName = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    PayTotal = table.Column<decimal>(type: "money", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Restaurants_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ratings_Restaurants_TargetId",
                        column: x => x.TargetId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrenderId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WeeklyTrends", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WeeklyTrends_Restaurants_TrenderId",
                        column: x => x.TrenderId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Menus_Restaurants_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuCategories_OwnerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WeeklyTrends_TrenderId",
                table: "WeeklyTrends",
                column: "TrenderId");
        }
